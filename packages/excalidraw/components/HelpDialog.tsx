...
const Header = () => (
  <div className="HelpDialog__header">
    <a
      ...
      href="https://github.com/RakeshChandraMahato/OpenDraw"
      target="_blank"
      rel="noopener"
    >
    ...
    <a
      className="HelpDialog__btn"
      href="https://github.com/RakeshChandraMahato/OpenDraw/blob/main/README.md"
      target="_blank"
      rel="noopener"
    >
      <div className="HelpDialog__link-icon">{ExternalLinkIcon}</div>
    ...
    <a
      className="HelpDialog__btn"
      href="https://github.com/RakeshChandraMahato/OpenDraw/issues"
      target="_blank"
    ...
    <a
      className="HelpDialog__btn"
      href="https://youtube.com/@rakeshxapp"
      target="_blank"
      rel="noopener noreferrer"
    >
