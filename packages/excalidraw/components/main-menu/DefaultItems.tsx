...
import { GithubIcon, DiscordIcon, XBrandIcon, InstagramIcon } from "../icons";
import {
  boltIcon,
  DeviceDesktopIcon,
  ExportIcon,
  ...
  return (
    <>
      <DropdownMenuItemLink
        icon={GithubIcon}
        href="https://github.com/RakeshChandraMahato"
        aria-label="GitHub"
      >
        GitHub
      </DropdownMenuItemLink>
      ...
      <DropdownMenuItemLink
        icon={InstagramIcon}
        href="https://instagram.com/rakeshxapp"
